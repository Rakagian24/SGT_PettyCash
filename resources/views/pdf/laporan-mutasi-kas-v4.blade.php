...
<head>
    ...
    <style>
        * {
        ...
        .th-tanggal { padding: 2px 2px; }
        .th-nomor { padding: 3px 0px; }
        .th-dari { padding: 3px 2px; }
        .th-keterangan { padding: 3px 2px; }
        .th-currency { padding: 3px 0px; }
        
        .td-tanggal { padding: 2px 0px; text-align: center; }
        .td-nomor { padding: 6px 0px; text-align: center; }
        .td-dari { padding: 6px 7px; text-align: left; }
        .td-keterangan { padding: 6px 7px; text-align: left; }
        .td-currency { padding: 6px 7px; text-align: right; }
        ...
        .td-total-center { text-align: center; }
        .td-total-right { text-align: right; }
    </style>
</head>
<body>
    <div style="text-align: left; margin-bottom: 25px;">
        <h1 style="font-size: 16px; font-weight: bold; margin-bottom: 8px;">LAPORAN MUTASI {{ $jenisKas }} PT. GUNAJAYA SANTOSA</h1>
